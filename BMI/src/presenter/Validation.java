...
public class Validation {
	...
	public boolean showSelectedPerson(Main mainApp, Person selectedPerson, ObservableList<Person> dataToRetrieve){
		if (selectedPerson != null) {

			boolean okClicked = mainApp.personEditDialog(selectedPerson, dataToRetrieve);
	...
	public void showTablePerson(Main mainApp, TablePersonActionController tablePersonController){
		mainApp.showTablePersonView(tablePersonController);
	}
